package com.BlogTeste.configuracao;
...
public class SwaggerConfig
{
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.BlogTeste.controladores")).paths(PathSelectors.any())
	...
	public static ApiInfo metadata()
	{
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/GuiMatheus/Testeprojetoblog")
				.contact((Contact) contact()).build();
	}

	private static Contact contact()
	{
		return new Contact("Gui Matheus", "https://github.com/GuiMatheus", "guilherme.maths.sil@gmail.com");
	}
